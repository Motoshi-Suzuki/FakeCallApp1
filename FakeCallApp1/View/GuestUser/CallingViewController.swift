...
class CallingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let callerLabelPosition = CGPoint(x: (screenWidth - callerNameLabel.frame.width) / 2, y: screenHeight * 0.11)
        callerNameLabel.frame.origin = callerLabelPosition
        ...
        hangUpButton.frame.origin = CGPoint(x: keypadButton.frame.origin.x, y: (screenHeight - faceTimeLabel.frame.origin.y) / 2 - buttonSize.height / 2 + faceTimeLabel.frame.origin.y)
